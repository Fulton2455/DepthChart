...
- **Due Date**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) then delete this comment --> 2/20 @1:50 PM EST
...
I am going to implement a depth chart component. I think this is a good choice because I can make it for several sports and include methods to remove players, add players, get the size of the team, etc. For the client, they can print off the first player in each position to print the starting lineup, they can use it for their teams if they are coaches to organize their players, to know how large their roster is to see if they need to make cuts or additions, etc.
